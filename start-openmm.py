...
if __name__ == "__main__":
    ...
    settings = {
        "task": {
            ...
            "wrapper": {
                "type": "default",
                "command": f"zsh -c 'source ~/.zshrc && conda activate {conda_env} && /usr/bin/env python3 {Path(__file__).parent.joinpath('run-openmm.py')} {simulation_path} && conda deactivate'",
                "mixed_stdout": True,
            },
        }
    }
